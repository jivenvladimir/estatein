				...
				<div class="estatein-properties-grid-section" data-node-id="97:8445">
					...
					<div class="estatein-properties-pagination" data-node-id="130:6163">
						<div class="estatein-pagination-info" data-node-id="130:6164">
							<?php
							$total_pages = $properties_query->max_num_pages ? $properties_query->max_num_pages : 1;
							?>
						...
						<div class="estatein-form-field estatein-form-field-wide" data-node-id="97:8662">
							...
							<div class="estatein-contact-method-group" data-node-id="97:8742">
								<div class="estatein-contact-method-option">
									<input type="radio" name="contact_method" value="phone" id="contact-phone" class="estatein-contact-method-radio">
									<label for="contact-phone" class="estatein-contact-method-label">
								...
								<div class="estatein-contact-method-option">
									<input type="radio" name="contact_method" value="email" id="contact-email" class="estatein-contact-method-radio">
									<label for="contact-email" class="estatein-contact-method-label">
